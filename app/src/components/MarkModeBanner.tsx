...
// Mark Mode is active. Non-blocking — pure guidance, exits cleanly. (The
// park bulk-add entry lives in the FilterBar, next to search, where the
// same button sits on /me and /rank.)
