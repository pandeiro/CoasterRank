    ...
    <div className="relative flex items-center" ref={menuRef}>
      ...
      {isOpen && (
        <>
          ...
          <div
            className="fixed inset-x-0 top-16 z-50 border-b border-line bg-surface-bright shadow-lg sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-2 sm:w-48 sm:rounded-xl sm:border sm:border-line sm:shadow-lift"
            role="menu"
          >
