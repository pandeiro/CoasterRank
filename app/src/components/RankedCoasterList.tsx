  ...
  return (
    <li>
      <button
        type="button"
        onClick={onClick}
        className="group flex min-h-11 w-full items-center gap-2 rounded-lg py-2 text-sm font-medium text-muted transition-colors hover:bg-accent/5 hover:text-accent-text sm:min-h-0 sm:py-1 sm:text-xs"
      >
