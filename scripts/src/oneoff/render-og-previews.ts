  ...
  const personas: Persona[] = [
    {
      ...
      rides: [
        { rank: 1, name: 'Steel Vengeance', park_name: 'Cedar Point', manufacturer_name: null },
        {
          rank: 2,
          name: 'VelociCoaster',
        ...
        { rank: 3, name: 'Zadra', park_name: 'Energylandia', manufacturer_name: null },
        {
          rank: 4,
          name: 'El Toro',
    ...
    },
    {
      ...
      rides: [
        ...
        { rank: 2, name: 'Zadra', park_name: 'Energylandia', manufacturer_name: null },
        {
          rank: 3,
          name: 'El Toro',
          park_name: 'Six Flags Great Adventure',
        ...
        { rank: 5, name: 'Fury 325', park_name: 'Carowinds', manufacturer_name: null },
      ],
    },
    {
      ...
      rides: [
        { rank: 1, name: 'Big Thunder Mountain', park_name: 'Disneyland', manufacturer_name: null },
        { rank: 2, name: 'Space Mountain', park_name: 'Disneyland', manufacturer_name: null },
        { rank: 3, name: 'Matterhorn Bobsleds', park_name: 'Disneyland', manufacturer_name: null },
      ],
    },
    {
      file: 'empty.png',
