...
| `02-rank-workbench-desktop.png` | `/rank` with a seeded 3-coaster guest list: "New Rider Ranking" banner ("Drag to re-order your lineup"), the spreadsheet alternate-path line (Sign Up link), the same sortable cards as `/me`, coral sticky "Save Ranking & Join Board". |
